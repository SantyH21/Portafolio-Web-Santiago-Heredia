...
// Navigation items
const navItems = [// agregar mas items si es necesario
            ...
            <div className="container flex items-center justify-between">
                <a className="text-xl font-bold flex items-center">
                    <span className="relative z-10">
                        <span className="text-glow text-foreground">Santiago Heredia</span>
                        {" "}
                ...
                <div className={cn("fixed inset-0 bg-backgroud/95 backdroup-blur-md z-40 flex flex-col items-center justify-center",
